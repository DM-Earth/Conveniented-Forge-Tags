...
public class TagMergeRules {
	public static final TagMergeRule DOUBLE_INGOTS = register(new TagMergeRule.Simple("double_ingots"));
	...
	public static final TagMergeRule WIRES = register(new TagMergeRule.Simple("wires"));
	public static final TagMergeRule COINS = register(new TagMergeRule.Simple("coins"));
	public static final TagMergeRule GEARS = register(new TagMergeRule.Simple("gears"));
	...
	public static final TagMergeRule RAW_ORES = register(new TagMergeRule.Custom(f -> f.startsWith("raw_ores") || f.startsWith("raw_materials/") ? "raw_" + f.replaceAll("raw_ores/", "").replaceAll("raw_materials/", "") + "_ores" : null, c -> c.startsWith("raw_") && c.endsWith("_ores") ? "raw_ores/" + c.replaceAll("raw_", "").replaceAll("_ores", "") : null));
